...
<div style="margin-left: 2vw; margin-right: 2vw; margin-top: 2vw">
    ...
    <form class="row g-3" action="/actions/admin/category/add_cat.php" method="post">
        <div class="col-md-4">
            <label for="validationServer01" class="form-label">Новоя категория</label>
            <input type="text" class="form-control" name="new_cat" id="validationServer01" >
            <div class="col-12">
            ...
            <div class="col-12">
                <button class="btn btn-primary" type="submit" style="background-color: #FFEEEE; color: black; border-color: #FFEEEE">Добавить</button>
            </div>
    </form>
</div>
